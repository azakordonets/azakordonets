...
- [How to print nicely in MacOS terminal path with spaces using pwd](https://biercoff.com/how-to-print-nicely-in-macos-terminal-path-with-spaces-using-pwd/)
- [Switching to main/master branch easily](https://biercoff.com/switching-to-main-master-branch-easily/)
- [Measuring elapsed time in milliseconds in bash](https://biercoff.com/measuring-elapsed-time-in-milliseconds-in-bash/)
